// 참고: https://github.com/FEBC-15/js/blob/main/workspace-ins/ch09/ex09-todolist/yong/utils.ts
// 참고: https://github.com/FEBC-15/js/blob/main/docs/09.js_ajax.md#6-axios-라이브러리
import axios from "axios";

const API_SERVER = "https://fesp-api.koyeb.app/market";

// 1. axios instance를 생성해서 반환하는 getAxiosInstance() 함수 작성
